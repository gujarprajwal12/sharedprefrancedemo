package gujarprawjal12gmail.com.example.sharedprefrancedemo
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        editor.putString("name", "Prajwal")
        editor.putInt("code", 7040)
        editor.commit()
        ...
        editor = pref1.edit()
        editor.putString("city", "Shevgaon")
        editor.putInt("pin", 414502)
        editor.commit()
